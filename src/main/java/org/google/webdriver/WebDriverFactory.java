...
public class WebDriverFactory {
  public static EventFiringWebDriver init(String browser, boolean grid) throws IOException {
    ...
    if (grid) {
      if (browser.equals("chrome")) {
        ...
        System.err.println("Unknown browser. Supported browsers are: chrome, firefox, iexplore");
      }
      MyCustomRemoteWebDriver remoteDriver = new MyCustomRemoteWebDriver(new URL(
